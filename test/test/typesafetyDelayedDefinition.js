...
classSystem._resolveProvisional(PL$2/*type:C1*/, classSystem.createClass({className: "C1",members: [{"name":"m1","type":PL$5/*type:C2*/}], "extends": [], "hasFreePart": true}, {"m1": undefined}));PL$3/*C1*/;;
classSystem._resolveProvisional(PL$5/*type:C2*/, classSystem.createClass({className: "C2",members: [{"name":"m2","type":PL$2/*type:C1*/},{"name":"a","type":classSystem.getBuiltinType("var")}], "extends": [], "hasFreePart": true}, {"m2": undefined, "a": 1}));PL$6/*C2*/;;
