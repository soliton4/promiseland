...
promiseland.registerRemote("server", "12ec951a9167283bf1517db6d7d26aa4", "PL$18", f, (classSystem.createFunctionType({ "return": PL$10/*type:C1**/, arguments: [classSystem.getBuiltinType("var")]})));
if (promiseland.profileHas("server")){
return f;
}else{
return function(){
return promiseland.remoteExec("12ec951a9167283bf1517db6d7d26aa4", "PL$18", arguments);
}
};
...
promiseland.registerRemote("server", "12ec951a9167283bf1517db6d7d26aa4", "PL$24", f, classSystem.getBuiltinType("var"));
if (promiseland.profileHas("server")){
return f;
}else{
return function(){
return promiseland.remoteExec("12ec951a9167283bf1517db6d7d26aa4", "PL$24", arguments);
}
};
})(function(){
...
return PL$29;
  ...
  var PL$34 = new __Promise();if(PL$9/*isClient*/){
    PL$28/*fx*/().then(PL$6(function(PL$35){PL$35;
    PL$25/*check*/().then(PL$6(function(PL$36){PL$27/*serverDestroyed*/ = PL$36;
    PL$34.resolve();;}), PL$7);
;}), PL$7);
;
  }else{
