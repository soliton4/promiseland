...
PL$9/*promiseland exception catcher*/(function(){
  ...
  var PL$35 = new __Promise();if(PL$12/*isClient*/){
    PL$28/*fx*/().then(PL$9/*promiseland exception catcher*/(function(PL$36){PL$36;
    PL$20/*check*/().then(PL$9/*promiseland exception catcher*/(function(PL$37){PL$27/*serverDestroyed*/ = PL$37;
  ...
  PL$35.resolve();;
  };PL$35.then(PL$9/*promiseland exception catcher*/(function(PL$38){PL$38;;
  ;
  if((PL$26/*tempres*/ != 2)){
    PL$1.resolve({
      "success": false
