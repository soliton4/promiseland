...
promiseland._registerModule({ hashStr: "316f7703caae55c1b409374995265da1", "module": _V1, promising: true });
var _V2 = (function(){
"use strict";
...
promiseland.registerRemote("server", "316f7703caae55c1b409374995265da1", "_V18", f, (classSystem.createFunctionType({ "return": _V10/*type:C1**/, arguments: [classSystem.getBuiltinType("var")]})));
if (promiseland.profileHas("server")){
return f;
}else{
return function(){
return promiseland.remoteExec("316f7703caae55c1b409374995265da1", "_V18", arguments);
}
};
...
promiseland.registerRemote("server", "316f7703caae55c1b409374995265da1", "_V24", f, classSystem.getBuiltinType("var"));
if (promiseland.profileHas("server")){
return f;
}else{
return function(){
return promiseland.remoteExec("316f7703caae55c1b409374995265da1", "_V24", arguments);
}
};
})(function(){
...
;
_V25/*check*/().then(_V30(function(_V34){_V27/*serverDestroyed*/ = _V34;;
...
if(_V9/*isClient*/){
_V28/*fx*/().then(_V6(function(_V36){_V36;;
_V35.resolve();;
}), _V7);
;
}else{
