...
promiseland.registerRemote("server", "316f7703caae55c1b409374995265da1", "PL$19", f, (classSystem.createFunctionType({ "return": PL$6/*type:C1**/, arguments: [classSystem.getBuiltinType("var")]})));
if (promiseland.profileHas("server")){
return f;
}else{
return function(){
return promiseland.remoteExec("316f7703caae55c1b409374995265da1", "PL$19", arguments);
}
};
...
promiseland.registerRemote("server", "316f7703caae55c1b409374995265da1", "PL$25", f, classSystem.getBuiltinType("var"));
if (promiseland.profileHas("server")){
return f;
}else{
return function(){
return promiseland.remoteExec("316f7703caae55c1b409374995265da1", "PL$25", arguments);
}
};
})(function (){
...
;
    PL$20/*check*/().then(PL$30(function(PL$34){PL$27/*serverDestroyed*/ = PL$34;
...
return PL$29;
  ...
  var PL$35 = new __Promise();if(PL$12/*isClient*/){
    PL$28/*fx*/().then(PL$9(function(PL$36){PL$36;
    PL$35.resolve();;}), PL$10);
;
  }else{
