...
promiseland.registerRemote("server", "caf0c3109062b882aacfaff9e264661e", "PL$22", f, (classSystem.createFunctionType({ "return": classSystem.getBuiltinType("var"), arguments: [PL$3/*type:C2*/]})));
if (promiseland.profileHas("server")){
return f;
}else{
return function(){
return promiseland.remoteExec("caf0c3109062b882aacfaff9e264661e", "PL$22", arguments);
}
};
})(function(PL$18/*par1*/){
...
promiseland.registerRemote("server", "caf0c3109062b882aacfaff9e264661e", "PL$27", f, classSystem.getBuiltinType("var"));
if (promiseland.profileHas("server")){
return f;
}else{
return function(){
return promiseland.remoteExec("caf0c3109062b882aacfaff9e264661e", "PL$27", arguments);
}
};
})(function(){
