...
promiseland.registerRemote("server", "367388894588dfac0390ede580e7148f", "PL$19", f, (classSystem.createFunctionType({ "return": PL$6/*type:C1**/, arguments: [classSystem.getBuiltinType("var")]})));
if (promiseland.profileHas("server")){
return f;
}else{
return function(){
return promiseland.remoteExec("367388894588dfac0390ede580e7148f", "PL$19", arguments);
}
};
...
promiseland.registerRemote("server", "367388894588dfac0390ede580e7148f", "PL$25", f, classSystem.getBuiltinType("var"));
if (promiseland.profileHas("server")){
return f;
}else{
return function(){
return promiseland.remoteExec("367388894588dfac0390ede580e7148f", "PL$25", arguments);
}
};
})(function (){
...
PL$9/*promiseland exception catcher*/(function(){
  ...
  var PL$35 = new __Promise();if(PL$27/*isClient*/){
    PL$28/*f*/().then(PL$9/*promiseland exception catcher*/(function(PL$36){PL$36;
    PL$35.resolve();;}), PL$10/*catch rejected*/);
    ;
  }else{
  PL$1.resolve({
    "success": true
  ...
  PL$35.resolve();;
  };PL$35.then(PL$9/*promiseland exception catcher*/(function(PL$37){PL$37;;
  ;
  if((PL$26/*tempres*/ != 2)){
    PL$1.resolve({
      "success": false
  ...
  ;
  PL$20/*check*/().then(PL$9/*promiseland exception catcher*/(function(PL$38){if(PL$38){
    PL$1.resolve({
      "success": true
    }); return;
  };
