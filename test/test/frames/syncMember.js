...
promiseland.registerRemote("server", "3464f0b2cb932a8dc0808a9f1dae1715", "PL$24", f, (classSystem.createFunctionType({ "return": classSystem.getBuiltinType("var"), arguments: [PL$6/*type:C2*/]})));
if (promiseland.profileHas("server")){
return f;
}else{
return function(){
return promiseland.remoteExec("3464f0b2cb932a8dc0808a9f1dae1715", "PL$24", arguments);
}
};
})(function(PL$20/*par1*/){
...
promiseland.registerRemote("server", "3464f0b2cb932a8dc0808a9f1dae1715", "PL$29", f, classSystem.getBuiltinType("var"));
if (promiseland.profileHas("server")){
return f;
}else{
return function(){
return promiseland.remoteExec("3464f0b2cb932a8dc0808a9f1dae1715", "PL$29", arguments);
}
};
})(function(){
...
classSystem._resolveProvisional(PL$3/*type:C1*/, classSystem.createClass({members: [{"name":"a","type":classSystem.getBuiltinType("var")},{"name":"b","type":classSystem.getBuiltinType("var")}], "extends": [], "hasFreePart": true, "sync": {"type":"sync","all":1,"line":9,"column":12,"offset":87}, "hashStr": "3464f0b2cb932a8dc0808a9f1dae1715", "name": "C1"}, {"a": 1, "b": 2}));PL$4/*C1*/;;
...
PL$30/*getLocalTB*/().then(PL$9(function(PL$36){if((PL$36 !== 5)){
PL$1.resolve({"success": false}); return;;
};
;
PL$1.resolve({"success": true}); return;;
