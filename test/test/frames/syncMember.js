...
promiseland.registerRemote("server", "3464f0b2cb932a8dc0808a9f1dae1715", "PL$25", f, (classSystem.createFunctionType({ "return": classSystem.getBuiltinType("var"), arguments: [PL$6/*type:C2*/]})));
if (promiseland.profileHas("server")){
return f;
}else{
return function(){
return promiseland.remoteExec("3464f0b2cb932a8dc0808a9f1dae1715", "PL$25", arguments);
}
};
})(function (PL$21/*par1*/){
...
promiseland.registerRemote("server", "3464f0b2cb932a8dc0808a9f1dae1715", "PL$30", f, classSystem.getBuiltinType("var"));
if (promiseland.profileHas("server")){
return f;
}else{
return function(){
return promiseland.remoteExec("3464f0b2cb932a8dc0808a9f1dae1715", "PL$30", arguments);
}
};
})(function (){
...
return PL$15;
  ...
  PL$20/*x*/((function(v){ if(!v){ return; }; return [v, v[2]()];})(PL$12/*local*/)).then(PL$9(function(PL$34){PL$33/*tempRes*/ = PL$34;
  PL$26/*getLocalTB*/().then(PL$9(function(PL$35){if((PL$35 !== 6)){
    PL$1.resolve({"success": false}); return;
  };
  ;
  (function(s, v){ v = s[10](v); s[9] = v; return v; })(PL$12/*local*/[11], 5);
  PL$26/*getLocalTB*/().then(PL$9(function(PL$36){if((PL$36 !== 5)){
    PL$1.resolve({"success": false}); return;
  };
  ;
  PL$1.resolve({"success": true}); return;
