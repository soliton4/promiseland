...
promiseland._registerModule({ hashStr: "0e5ca56b1590158be3142dbee3a1200e", "module": _V1, promising: true });
var _V2 = (function(){
"use strict";
...
promiseland.registerRemote("server", "0e5ca56b1590158be3142dbee3a1200e", "_V18", f, (classSystem.createFunctionType({ "return": _V10/*type:C1**/, arguments: [classSystem.getBuiltinType("var")]})));
if (promiseland.profileHas("server")){
return f;
}else{
return function(){
return promiseland.remoteExec("0e5ca56b1590158be3142dbee3a1200e", "_V18", arguments);
}
};
...
promiseland.registerRemote("server", "0e5ca56b1590158be3142dbee3a1200e", "_V24", f, classSystem.getBuiltinType("var"));
if (promiseland.profileHas("server")){
return f;
}else{
return function(){
return promiseland.remoteExec("0e5ca56b1590158be3142dbee3a1200e", "_V24", arguments);
}
};
})(function(){
