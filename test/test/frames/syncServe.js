...
promiseland.registerRemote("server", "0e5ca56b1590158be3142dbee3a1200e", "PL$18", f, (classSystem.createFunctionType({ "return": PL$10/*type:C1**/, arguments: [classSystem.getBuiltinType("var")]})));
if (promiseland.profileHas("server")){
return f;
}else{
return function(){
return promiseland.remoteExec("0e5ca56b1590158be3142dbee3a1200e", "PL$18", arguments);
}
};
...
promiseland.registerRemote("server", "0e5ca56b1590158be3142dbee3a1200e", "PL$24", f, classSystem.getBuiltinType("var"));
if (promiseland.profileHas("server")){
return f;
}else{
return function(){
return promiseland.remoteExec("0e5ca56b1590158be3142dbee3a1200e", "PL$24", arguments);
}
};
})(function(){
...
return PL$29;
  ...
  var PL$35 = new __Promise();if(PL$9/*isClient*/){
...
;
  ...
  PL$35.resolve();;
  };PL$35.then(PL$6(function(PL$37){PL$37;;
  ;
  if((PL$26/*tempres*/ != 2)){
