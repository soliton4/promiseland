...
if (promiseland._hasModule({ hashStr: "5fb4d4ee25f3e2cf84d15b5b095f14c3" })){ return promiseland._getModule("5fb4d4ee25f3e2cf84d15b5b095f14c3"); };
var PL$1 = new __Promise();
promiseland._registerModule({ hashStr: "5fb4d4ee25f3e2cf84d15b5b095f14c3", "module": PL$1, promising: true });
...
PL$27/*i*/ = 0;
PL$28/*o*/ = {};
for(PL$27/*i*/ = 0;(PL$27/*i*/ < PL$11/*par*/["propertiesAr"]["length"]);++PL$27/*i*/){{if((PL$11/*par*/["propertiesAr"][PL$27/*i*/]["name"] == "id")){
continue;;
};
;
...
PL$23/*promiseland*/["classSystem"]["setSaveHandler"](new PL$35/*SaveHandler*/());;
...
"y": true};
PL$27/*i*/;
for(PL$27/*i*/ in PL$38/*mustHaveObj*/){if(! PL$9/*collector*/["register"]["properties"][PL$27/*i*/]){
PL$1.resolve({"success": false}); return;;
};
;
};
