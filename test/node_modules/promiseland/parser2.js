    ...
    var CodeParser = function(par){
      ...
      */
      ...
      this.createExtraDynamicType = function(parType, par, parParsed){
        ...
        return this.getType(name, parParsed);
      ...
      */
      ...
      this.expExpressionStatement = function(parParsed){
        var res = this.getDestroyTemporaryClassCode(parParsed);
      ...
      this.expNewExpression = function(par){
        ...
        if (par.callee && par.callee.type == "Identifier"){
          ...
          if (type){
            ...
            res.push("(");
            typed = true;
            res.setType(classSystem._createTemporaryTrackedClass(type));
          };
        };
        if (!typed){
          res.push("new ");
      ...
      */
      ...
      this.getDestroyTemporaryClassCode = function(parParsed, par){
        var res = this.newResult();
        
        var value = this.parseExpression(parParsed);
        ...
        res.setType(classSystem.getClassFromTemporaryTracked(valueType));
