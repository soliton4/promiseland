...
if (!promiseland._registerModule("b84ffe21642945e905a4c3f179551605", __module.promise.then)){ return promiseland._getModule("b84ffe21642945e905a4c3f179551605"); };
(function(){
var somefun;
...
c["promise"].then(function(__UNIQUENAME1){try{x = __UNIQUENAME1[0];
_returnPs.resolve((par + x)); return _returnPs;
...
a = 1;
console["log"]("1");
somefun(a).then(function(__UNIQUENAME2){try{if((__UNIQUENAME2 == 6)){
