...
promiseland.registerRemote("server", "f6eb2f32b4cecef1b45032dd98625bfa", "PL$25", f, (classSystem.createFunctionType({ "return": classSystem.getBuiltinType("var"), arguments: [PL$6/*type:C2*/]})));
if (promiseland.profileHas("server")){
return f;
}else{
return function(){
return promiseland.remoteExec("f6eb2f32b4cecef1b45032dd98625bfa", "PL$25", arguments);
}
};
})(function (PL$21/*par1*/){
...
promiseland.registerRemote("server", "f6eb2f32b4cecef1b45032dd98625bfa", "PL$30", f, classSystem.getBuiltinType("var"));
if (promiseland.profileHas("server")){
return f;
}else{
return function(){
return promiseland.remoteExec("f6eb2f32b4cecef1b45032dd98625bfa", "PL$30", arguments);
}
};
})(function (){
