...
promiseland._registerModule({ hashStr: "b0243ff5472a9a8301b99178ac02419c", "module": _V1, promising: true });
...
__requireFun("./testmodules/syncMember").then(_V3(function(_V31){_V31;;
_V1.resolve(); return;;
}), _V4);
;}), _V4);
;}), _V4);
