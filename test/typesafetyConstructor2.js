...
_V8/*b*/[3] = 3;;
classSystem._resolveProvisional(_V5/*type:C1*/, classSystem.createClass({members: [{"name":"a","type":_V2/*type:C2*/},{"name":"constructor","type":(classSystem.createFunctionType({ "return": classSystem.getBuiltinType("var"), arguments: [_V2/*type:C2*/]}))}], "extends": [], "hasFreePart": true}, {"a": new _V4/*C2-constructor*/(), "constructor": (function(_V9/*par1*/){
;
this[3] = _V9/*par1*/;;
;
})}));_V6/*C1*/;;
_V10/*v1*/ = new _V7/*C1-constructor*/(_V8/*b*/);
if((_V10/*v1*/[3][3] == 3)){
return {"success": true};;
};
;
