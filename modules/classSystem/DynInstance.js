...
;
PL$13/*passedType*/ = PL$4/*classSystem*/["getTypeFromInstance"](PL$12/*parInstance*/);
...
PL$14/*track*/ = this["getTrack"]();
this["extraTracks"]["push"](PL$14/*track*/);;
return [this["instance"], PL$14/*track*/];;
};
;
...
;
PL$15/*i*/ = 0;
for(PL$15/*i*/ = 0;(PL$15/*i*/ < this["extraTracks"]["length"]);++PL$15/*i*/){{try
{this["extraTracks"][PL$15/*i*/]();;
}catch(PL$16/*e*/){};
;
}};
;
